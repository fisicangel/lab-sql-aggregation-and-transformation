...
SELECT
    FLOOR(ROUND(AVG(length)) / 60) AS average_hours,
...
-- CHALLENGE 2: 1. Next, you need to analyze the films in the collection to gain some more insights.
...
-- BONUS: Bonus: determine which last names are not repeated in the table actor.
SELECT
    last_name
FROM actor
GROUP BY last_name
